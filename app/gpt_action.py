...
async def build_slip_candidates(
    ...
    response = build_slip_candidate_response(
        ...
        min_legs=_clean_int(min_legs, 1, 16),
        max_legs=_clean_int(max_legs, 1, 16),
            ...
            "application/json": {
                "schema": {
                    ...
                    "properties": {
                        ...
                        "targetOddsMin": {"type": "number", "minimum": 1, "maximum": 501},
                        "targetOddsMax": {"type": "number", "minimum": 1, "maximum": 501},
                        "minLegs": {"type": "integer", "minimum": 1, "maximum": 16},
                        "maxLegs": {"type": "integer", "minimum": 1, "maximum": 16},
                        "mode": {
                            "type": "string",
                            "enum": [
                                "balanced",
